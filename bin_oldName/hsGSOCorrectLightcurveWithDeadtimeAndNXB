...
cat << EOF
usage :
gso_lightcurve_correct_deadtime_and_nxb.sh (event lightcurve file) (nxb lightcurve file) (pseudo lightcurve file) (output filename prefix) (ehk file; optional) (output plot prefix; optional)
...
energy_lowcut=`gso_pi_to_energy.rb $phalowcut`
energy_highcut=`gso_pi_to_energy.rb $phahighcut`
...
fits_dump_columns.sh ${nxblc_dtcor} 1 TIME,RATE,ERROR >> $tmpqdp
echo "NO NO NO" >> $tmpqdp
